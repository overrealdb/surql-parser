use crate::upstream::sql::TableType;
use crate::upstream::sql::statements::alter::field::AlterDefault;
...
use crate::upstream::sql::statements::{AlterStatement, AlterTableStatement};
			...
			match self.peek_kind() {
				t!("DROP") => {
					...
					match peek.kind {
						...
						_ => unexpected!(self, peek, "`COMMENT` or `CHANGEFEED`"),
					}
				}
				t!("COMMENT") => {
					self.pop_peek();
