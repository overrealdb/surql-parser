...
use crate::upstream::sql::{AssignOperator, ExplainFormat, Expr, Literal, Param, TopLevelExpr};
					...
					match self.peek_kind() {
						t!("EXPIRED") => {
							...
							match kind {
								...
								_ => {
									unexpected!(self, peek, "ACCESS PURGE statement to end")
								}
							}
						}
						t!("REVOKED") => {
