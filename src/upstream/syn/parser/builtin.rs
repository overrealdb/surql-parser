...
use crate::upstream::sql::{Constant, Expr, Function, FunctionCall};
use crate::upstream::syn::error::MessageKind;
use crate::upstream::syn::parser::mac::expected;
use crate::upstream::syn::parser::{SyntaxError, unexpected};
use crate::upstream::syn::token::{Span, t};
use phf::phf_map;
use reblessive::Stk;
use unicase::UniCase;
...
pub static PATHS: phf::Map<UniCase<&'static str>, (PathKind, Option<UniCase<&'static str>>)> = phf_map! {
	...
	UniCase::ascii("bytes::len") => (PathKind::Function, None), UniCase::ascii("count")
	=> (PathKind::Function, None), UniCase::ascii("crypto::blake3") =>
	(PathKind::Function, None), UniCase::ascii("crypto::joaat") => (PathKind::Function,
	None), UniCase::ascii("crypto::md5") => (PathKind::Function, None),
	...
	Some(UniCase::ascii("duration::from::days"))), UniCase::ascii("duration::from_hours")
	=> (PathKind::Function, Some(UniCase::ascii("duration::from::hours"))),
	UniCase::ascii("duration::from_micros") => (PathKind::Function,
	Some(UniCase::ascii("duration::from::micros"))),
	UniCase::ascii("duration::from_millis") => (PathKind::Function,
	Some(UniCase::ascii("duration::from::millis"))),
	UniCase::ascii("duration::from_mins") => (PathKind::Function,
	Some(UniCase::ascii("duration::from::mins"))), UniCase::ascii("duration::from_nanos")
	=> (PathKind::Function, Some(UniCase::ascii("duration::from::nanos"))),
	UniCase::ascii("duration::from_secs") => (PathKind::Function,
	Some(UniCase::ascii("duration::from::secs"))), UniCase::ascii("duration::from_weeks")
	=> (PathKind::Function, Some(UniCase::ascii("duration::from::weeks"))),
	...
	UniCase::ascii("math::ln") => (PathKind::Function, None), UniCase::ascii("math::log")
	=> (PathKind::Function, None), UniCase::ascii("math::log10") => (PathKind::Function,
	None), UniCase::ascii("math::log2") => (PathKind::Function, None),
	...
	UniCase::ascii("meta::id") => (PathKind::Function, None), UniCase::ascii("meta::tb")
	=> (PathKind::Function, None), UniCase::ascii("not") => (PathKind::Function, None),
	...
	UniCase::ascii("rand") => (PathKind::Function, None), UniCase::ascii("rand::bool") =>
	(PathKind::Function, None), UniCase::ascii("rand::duration") => (PathKind::Function,
	None), UniCase::ascii("rand::enum") => (PathKind::Function, None),
	UniCase::ascii("rand::float") => (PathKind::Function, None),
	UniCase::ascii("rand::id") => (PathKind::Function,
	Some(UniCase::ascii("rand::guid"))), UniCase::ascii("rand::int") =>
	(PathKind::Function, None), UniCase::ascii("rand::string") => (PathKind::Function,
	None), UniCase::ascii("rand::time") => (PathKind::Function, None),
	...
	UniCase::ascii("set::add") => (PathKind::Function, None), UniCase::ascii("set::all")
	=> (PathKind::Function, None), UniCase::ascii("set::any") => (PathKind::Function,
	None), UniCase::ascii("set::at") => (PathKind::Function, None),
	...
	UniCase::ascii("set::last") => (PathKind::Function, None), UniCase::ascii("set::len")
	=> (PathKind::Function, None), UniCase::ascii("set::map") => (PathKind::Function,
	None), UniCase::ascii("set::max") => (PathKind::Function, None),
	...
	Some(UniCase::ascii("string::startsWith"))), UniCase::ascii("string::trim") =>
	(PathKind::Function, None), UniCase::ascii("string::uppercase") =>
	(PathKind::Function, None), UniCase::ascii("string::words") => (PathKind::Function,
	None), UniCase::ascii("string::distance::damerau_levenshtein") =>
	(PathKind::Function, None), UniCase::ascii("string::distance::hamming") =>
	(PathKind::Function, None), UniCase::ascii("string::distance::levenshtein") =>
	(PathKind::Function, None),
	UniCase::ascii("string::distance::normalized_damerau_levenshtein") =>
	(PathKind::Function, None),
	UniCase::ascii("string::distance::normalized_levenshtein") => (PathKind::Function,
	None), UniCase::ascii("string::distance::osa") => (PathKind::Function,
	Some(UniCase::ascii("string::distance::osa_distance"))),
	...
	Some(UniCase::ascii("string::is::alphanum"))), UniCase::ascii("string::is_alpha") =>
	(PathKind::Function, Some(UniCase::ascii("string::is::alpha"))),
	UniCase::ascii("string::is_ascii") => (PathKind::Function,
	Some(UniCase::ascii("string::is::ascii"))), UniCase::ascii("string::is_datetime") =>
	(PathKind::Function, Some(UniCase::ascii("string::is::datetime"))),
	UniCase::ascii("string::is_domain") => (PathKind::Function,
	Some(UniCase::ascii("string::is::domain"))), UniCase::ascii("string::is_email") =>
	(PathKind::Function, Some(UniCase::ascii("string::is::email"))),
	UniCase::ascii("string::is_hexadecimal") => (PathKind::Function,
	Some(UniCase::ascii("string::is::hexadecimal"))), UniCase::ascii("string::is_ip") =>
	(PathKind::Function, Some(UniCase::ascii("string::is::ip"))),
	UniCase::ascii("string::is_ipv4") => (PathKind::Function,
	Some(UniCase::ascii("string::is::ipv4"))), UniCase::ascii("string::is_ipv6") =>
	(PathKind::Function, Some(UniCase::ascii("string::is::ipv6"))),
	UniCase::ascii("string::is_latitude") => (PathKind::Function,
	Some(UniCase::ascii("string::is::latitude"))), UniCase::ascii("string::is_longitude")
	=> (PathKind::Function, Some(UniCase::ascii("string::is::longitude"))),
	UniCase::ascii("string::is_numeric") => (PathKind::Function,
	Some(UniCase::ascii("string::is::numeric"))), UniCase::ascii("string::is_semver") =>
	(PathKind::Function, Some(UniCase::ascii("string::is::semver"))),
	UniCase::ascii("string::is_url") => (PathKind::Function,
	Some(UniCase::ascii("string::is::url"))), UniCase::ascii("string::is_ulid") =>
	(PathKind::Function, Some(UniCase::ascii("string::is::ulid"))),
	UniCase::ascii("string::is_uuid") => (PathKind::Function,
	Some(UniCase::ascii("string::is::uuid"))), UniCase::ascii("string::is_record") =>
	(PathKind::Function, Some(UniCase::ascii("string::is::record"))),
	...
	Some(UniCase::ascii("time::from::micros"))), UniCase::ascii("time::from_millis") =>
	(PathKind::Function, Some(UniCase::ascii("time::from::millis"))),
	UniCase::ascii("time::from_nanos") => (PathKind::Function,
	Some(UniCase::ascii("time::from::nanos"))), UniCase::ascii("time::from_secs") =>
	(PathKind::Function, Some(UniCase::ascii("time::from::secs"))),
	UniCase::ascii("time::from_ulid") => (PathKind::Function,
	Some(UniCase::ascii("time::from::ulid"))), UniCase::ascii("time::from_unix") =>
	(PathKind::Function, Some(UniCase::ascii("time::from::unix"))),
	UniCase::ascii("time::from_uuid") => (PathKind::Function,
	Some(UniCase::ascii("time::from::uuid"))), UniCase::ascii("time::is_leap_year") =>
	(PathKind::Function, Some(UniCase::ascii("time::is::leap_year"))),
	...
	Some(UniCase::ascii("type::thing"))), UniCase::ascii("type::set") =>
	(PathKind::Function, None), UniCase::ascii("type::string") => (PathKind::Function,
	None), UniCase::ascii("type::string_lossy") => (PathKind::Function, None),
	...
	Some(UniCase::ascii("type::is::array"))), UniCase::ascii("type::is_bool") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::bool"))),
	UniCase::ascii("type::is_bytes") => (PathKind::Function,
	Some(UniCase::ascii("type::is::bytes"))), UniCase::ascii("type::is_collection") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::collection"))),
	UniCase::ascii("type::is_datetime") => (PathKind::Function,
	Some(UniCase::ascii("type::is::datetime"))), UniCase::ascii("type::is_decimal") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::decimal"))),
	UniCase::ascii("type::is_duration") => (PathKind::Function,
	Some(UniCase::ascii("type::is::duration"))), UniCase::ascii("type::is_float") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::float"))),
	UniCase::ascii("type::is_geometry") => (PathKind::Function,
	Some(UniCase::ascii("type::is::geometry"))), UniCase::ascii("type::is_int") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::int"))),
	UniCase::ascii("type::is_line") => (PathKind::Function,
	Some(UniCase::ascii("type::is::line"))), UniCase::ascii("type::is_multiline") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::multiline"))),
	UniCase::ascii("type::is_multipoint") => (PathKind::Function,
	Some(UniCase::ascii("type::is::multipoint"))),
	UniCase::ascii("type::is_multipolygon") => (PathKind::Function,
	Some(UniCase::ascii("type::is::multipolygon"))), UniCase::ascii("type::is_none") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::none"))),
	UniCase::ascii("type::is_null") => (PathKind::Function,
	Some(UniCase::ascii("type::is::null"))), UniCase::ascii("type::is_number") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::number"))),
	UniCase::ascii("type::is_object") => (PathKind::Function,
	Some(UniCase::ascii("type::is::object"))), UniCase::ascii("type::is_point") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::point"))),
	UniCase::ascii("type::is_polygon") => (PathKind::Function,
	Some(UniCase::ascii("type::is::polygon"))), UniCase::ascii("type::is_range") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::range"))),
	UniCase::ascii("type::is_record") => (PathKind::Function,
	Some(UniCase::ascii("type::is::record"))), UniCase::ascii("type::is_set") =>
	(PathKind::Function, None), UniCase::ascii("type::is_string") => (PathKind::Function,
	Some(UniCase::ascii("type::is::string"))), UniCase::ascii("type::is_uuid") =>
	(PathKind::Function, Some(UniCase::ascii("type::is::uuid"))),
	...
	None), UniCase::ascii("math::FRAC_1_SQRT_2") =>
	(PathKind::Constant(Constant::MathFrac1Sqrt2), None),
	UniCase::ascii("math::FRAC_2_PI") => (PathKind::Constant(Constant::MathFrac2Pi),
	None), UniCase::ascii("math::FRAC_2_SQRT_PI") =>
	(PathKind::Constant(Constant::MathFrac2SqrtPi), None),
	UniCase::ascii("math::FRAC_PI_2") => (PathKind::Constant(Constant::MathFracPi2),
	None), UniCase::ascii("math::FRAC_PI_3") =>
	(PathKind::Constant(Constant::MathFracPi3), None), UniCase::ascii("math::FRAC_PI_4")
	=> (PathKind::Constant(Constant::MathFracPi4), None),
	UniCase::ascii("math::FRAC_PI_6") => (PathKind::Constant(Constant::MathFracPi6),
	None), UniCase::ascii("math::FRAC_PI_8") =>
	(PathKind::Constant(Constant::MathFracPi8), None), UniCase::ascii("math::INF") =>
	(PathKind::Constant(Constant::MathInfinity), None), UniCase::ascii("math::INFINITY")
	=> (PathKind::Constant(Constant::MathInfinity), None), UniCase::ascii("math::LN_10")
	=> (PathKind::Constant(Constant::MathLn10), None), UniCase::ascii("math::LN_2") =>
	(PathKind::Constant(Constant::MathLn2), None), UniCase::ascii("math::LOG10_2") =>
	(PathKind::Constant(Constant::MathLog102), None), UniCase::ascii("math::LOG10_E") =>
	(PathKind::Constant(Constant::MathLog10E), None), UniCase::ascii("math::LOG2_10") =>
	(PathKind::Constant(Constant::MathLog210), None), UniCase::ascii("math::LOG2_E") =>
	(PathKind::Constant(Constant::MathLog2E), None), UniCase::ascii("math::NEG_INF") =>
	(PathKind::Constant(Constant::MathNegInfinity), None),
	UniCase::ascii("math::NEG_INFINITY") =>
	(PathKind::Constant(Constant::MathNegInfinity), None), UniCase::ascii("math::PI") =>
	(PathKind::Constant(Constant::MathPi), None), UniCase::ascii("math::SQRT_2") =>
	(PathKind::Constant(Constant::MathSqrt2), None), UniCase::ascii("math::TAU") =>
	(PathKind::Constant(Constant::MathTau), None), UniCase::ascii("time::EPOCH") =>
	(PathKind::Constant(Constant::TimeEpoch), None), UniCase::ascii("time::MINIMUM") =>
	(PathKind::Constant(Constant::TimeMin), None), UniCase::ascii("time::MAXIMUM") =>
	(PathKind::Constant(Constant::TimeMax), None), UniCase::ascii("duration::MAX") =>
	(PathKind::Constant(Constant::DurationMax), None),
