...
impl From<GraphQLConfig> for crate::compat::catalog::GraphQLConfig {
	fn from(v: GraphQLConfig) -> Self {
		crate::compat::catalog::GraphQLConfig {
...
impl From<crate::compat::catalog::GraphQLConfig> for GraphQLConfig {
	fn from(v: crate::compat::catalog::GraphQLConfig) -> Self {
		GraphQLConfig {
			tables: v.tables.into(),
			functions: v.functions.into(),
			depth_limit: v.depth_limit,
...
impl From<TablesConfig> for crate::compat::catalog::GraphQLTablesConfig {
...
impl From<crate::compat::catalog::GraphQLTablesConfig> for TablesConfig {
	fn from(v: crate::compat::catalog::GraphQLTablesConfig) -> Self {
		match v {
			crate::compat::catalog::GraphQLTablesConfig::None => Self::None,
			crate::compat::catalog::GraphQLTablesConfig::Auto => Self::Auto,
			crate::compat::catalog::GraphQLTablesConfig::Include(cs) => Self::Include(
				cs.into_iter()
					.map(|t| TableConfig {
						name: t.to_string(),
					})
			...
			crate::compat::catalog::GraphQLTablesConfig::Exclude(cs) => Self::Exclude(
				cs.into_iter()
					.map(|t| TableConfig {
						name: t.to_string(),
					})
...
impl From<IntrospectionConfig> for crate::compat::catalog::GraphQLIntrospectionConfig {
...
impl From<crate::compat::catalog::GraphQLIntrospectionConfig> for IntrospectionConfig {
	fn from(v: crate::compat::catalog::GraphQLIntrospectionConfig) -> Self {
		match v {
			crate::compat::catalog::GraphQLIntrospectionConfig::Auto => Self::Auto,
			crate::compat::catalog::GraphQLIntrospectionConfig::None => Self::None,
		}
	}
}
...
impl From<FunctionsConfig> for crate::compat::catalog::GraphQLFunctionsConfig {
...
impl From<crate::compat::catalog::GraphQLFunctionsConfig> for FunctionsConfig {
	fn from(v: crate::compat::catalog::GraphQLFunctionsConfig) -> Self {
		match v {
			crate::compat::catalog::GraphQLFunctionsConfig::None => Self::None,
			crate::compat::catalog::GraphQLFunctionsConfig::Auto => Self::Auto,
			crate::compat::catalog::GraphQLFunctionsConfig::Include(cs) => Self::Include(cs),
			crate::compat::catalog::GraphQLFunctionsConfig::Exclude(cs) => Self::Exclude(cs),
		}
	}
}
