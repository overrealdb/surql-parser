use crate::upstream::sql::access_type::{JwtAccess, JwtAccessIssue, JwtAccessVerify};
use crate::upstream::sql::arbitrary::idiom::plain_idiom;
use crate::upstream::sql::arbitrary::{arb_vec1, arb_vec2, atleast_one, basic_idiom};
use crate::upstream::sql::field::Selector;
use crate::upstream::sql::order::{OrderList, Ordering};
use crate::upstream::sql::statements::access::Subject;
use crate::upstream::sql::statements::define::config::api::Middleware;
...
use crate::upstream::syn::parser::{PATHS, PathKind};
	...
	match expr {
		Fields::Value(selector) => {
			...
			match &selector.expr {
				...
				x => {
					let s = x.to_sql();
					let s = crate::upstream::syn::parse_with_settings(
						s.as_bytes(),
						crate::upstream::syn::ParserSettings {
