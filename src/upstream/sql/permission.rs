...
impl From<Permissions> for crate::compat::catalog::Permissions {
...
impl From<crate::compat::catalog::Permissions> for Permissions {
	fn from(v: crate::compat::catalog::Permissions) -> Self {
		Self {
			select: v.select.into(),
			create: v.create.into(),
			update: v.update.into(),
...
impl From<Permission> for crate::compat::catalog::Permission {
...
impl From<crate::compat::catalog::Permission> for Permission {
	fn from(v: crate::compat::catalog::Permission) -> Self {
		match v {
			crate::compat::catalog::Permission::None => Self::None,
			crate::compat::catalog::Permission::Full => Self::Full,
			crate::compat::catalog::Permission::Specific(v) => Self::Specific(v.into()),
		}
	}
}
